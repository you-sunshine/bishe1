<template>
  <div id="gohome" :style="bgphoto">
    <div class="addtit">
      <i class="el-icon-arrow-left" @click="goback"></i>
      温&nbsp;馨&nbsp;回&nbsp;家
    </div>
     <div id="boxes"  @click="change_c">
    ...
    change_c(){
     var userid = this.$store.state.username.userId;
        var msg={};
         msg.userId=userid;
        Axios.get(
        "http://182.92.194.165:8081/operate/device/onall",
        {
          params: msg
        },
...
.addtit {
  ...
  line-height: 60px;
  font-size: 1.2rem;
  background: linear-gradient(to right, rgb(233, 75, 2), blue);
...
.fireCont:nth-child(2) .fire {
  background: #ff6d33;
  box-shadow: 0px 0px 45px 5px rgba(245, 138, 77, 0.5);
}
